...
class Show(db.Model):
    ...
    venue = relationship(Venue, backref=backref("venue_artist", cascade="all, delete-orphan"))
    artist = relationship(Artist, backref=backref("venue_artist",cascade="all, delete-orphan"))
#----------------------------------------------------------------------------#
# Filters.
#----------------------------------------------------------------------------#
...
def create_venue_submission():
  ...
  try:
    ...
    print(name, city, state, address,phone,genres, image_link, facebook_link, 
  ...
  # TODO: modify data to be the data object returned from db inserti
